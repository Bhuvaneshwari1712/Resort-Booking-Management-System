    ...
    <div className="form-container">
      <form className="payment-form" onSubmit={handleBookPlace}>
        ...
        <div className="payment-field">
          <div className="date">
            <Space cirection="vertical" size={"12"}>
          ...
          <div className="guest">
            ...
            <br/>
            <input className="no-of-guest" placeholder="Number Of Guests" type="number" min="1" max={maximumGuest} required onChange={(e) => {
          ...
          <div className="name-phoneno">
            ...
            <br />
            <input type="text"   className="full-name" placeholder="Name" required onChange={(e) => {
              setUserData((prev) => ({ ...prev, name: e.target.value})) }}
              minLength="3"/>
              <br/>
              <label className="payment-labels">Phone Number:</label>
              <br/>
              <input type="tel" className="phone-number" placeholder="Number" maxLength="10" required onChange={(e) => {
